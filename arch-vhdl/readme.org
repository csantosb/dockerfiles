...
[[https://hub.docker.com/_/archlinux/][archlinux image]].
 ...
 - It includes latest [[https://aur.archlinux.org/packages/ghdl-gcc-git/][ghdl-gcc-git]] and [[https://aur.archlinux.org/packages/python-cocotb-git/][python-cocotb-git]] packages. It adds pre
   compiled Vivado 2019.2 libraries too
