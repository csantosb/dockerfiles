...
[[https://hub.docker.com/_/archlinux/][archlinux image]].
 ...
 - It includes [[https://osvvm.org/][osvvm]], [[https://aur.archlinux.org/packages/ghdl-gcc-git/][ghdl-gcc-git]], [[https://github.com/olofk/fusesoc][fusesoc]] and [[https://aur.archlinux.org/packages/python-cocotb/][python-cocotb]] packages. It adds pre compiled Vivado
